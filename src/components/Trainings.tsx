import { trainings, img } from "../data";
  ...
  return (
    <section id="trainings" className="relative border-y border-[var(--hairline)] bg-[var(--bg-2)] px-5 py-24 sm:px-6 sm:py-32">
      ...
      <SectionHead
        ...
        sub="Hands-on experience designing real product flows, interfaces, components, and responsive digital experiences."
      />

      <div className="flex flex-col gap-16 sm:gap-24">
        {trainings.map((t, i) => {
          const flip = i % 2 === 1;
          const image = <TrainingImage src={img(t.image, 780, 540)} alt={t.title} />;
          const text = (
          ...
          return (
            <div key={t.title} className="flex flex-col items-center gap-10 md:flex-row md:gap-16">
              {flip ? (
                <>
